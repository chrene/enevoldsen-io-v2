        ...
        <div className="max-w-7xl mx-auto py-24 ">
          <div className="grid grid-cols-2 gap-12">
            <div className="col-span-1">
              <h2 className="font-medium text-5xl text-yellow-50 leading-tight mb-8">
                Skal vi skabe noget fantastisk sammen?
              </h2>
              <div className="flex flex-col gap-3">
                <a href="tel:004553768161" className="text-xl font-bold text-gray-500">
                  +45 5376 8161
                </a>
          ...
          <div className="grid grid-cols-2 gap-12">
            <div className="col-span-1">
              ...
              <p className="">
                ...
                <span className="text-yellow-50">Alle rettigheder forbeholdes</span>
              </p>
            </div>
