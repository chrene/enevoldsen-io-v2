            ...
            <div className="grid grid-cols-2 gap-12 relative">
              <div className="col-span-2 md:col-span-1">
                <div className="sticky top-8">
                  <h2 className="font-bold md:font-medium text-3xl md:text-5xl text-gray-800 md:leading-tight mb-8">
                    Uddannet datalog med passion for webudvikling og product
                    management.
                  </h2>
