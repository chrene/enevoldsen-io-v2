...
const Header = ({
  ...
  const navLinkClass = classNames(
    "mx-auto lg:mx-0 hover:underline font-bold mt-4 lg:mt-0 py-4 px-8 opacity-75",
    {
      "text-white": textWhite || !scrolled,
      "text-black": !textWhite || scrolled,
    }
  );
  let navContentClass =
    "w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 text-black p-4 lg:p-0 z-20";
  navContentClass +=
    !textWhite || !scrolled ? " lg:bg-transparent bg-gray-100" : "";
